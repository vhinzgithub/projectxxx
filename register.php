...
<body>
		...
		<div id="main-content">
			...
			<div id="right-content"><!-- right-content -->
				...
				<div id="registration-container">
					<h3 id="page-title">New Member Registration</h3>
					<div id="registration-controls-container">
						<form>
				...
				<div id="registration-right-section">
					<h3>Anthing that can be</h3>
					<h3>Written on this side of the page</h3>
					<h3>or any promotions</h3>
					<br />
					<h4>Image is also great to make this page attractive</h4>
					<h4>It could also be a list</h4>
				</div>
			</div><!-- right-content -->
		</div>
	...
	<!-- THIS SHOULD BE PLACED THE PART FILE OF THE FOOTER -->
